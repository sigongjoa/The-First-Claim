        ...
        try:
            while time.perf_counter() - start_time < duration_seconds:
                try:
                    ...
                    errors += 1
                    logger.warning(f"작업 실패: {str(e)}", context={"operation": operations})
        ...
        try:
            ...
            logger.info(
                ...
                context={
                    ...
                    "degradation_ratio": (spike_time / normal_time) if normal_time > 0 else 0
                }
            )
